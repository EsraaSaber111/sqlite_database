...
//
//       String path = join(await getDatabasesPath(), 'school.dp');
// // خلصنا المسار هننشأ الداتا بيز نفسها
//       _dp = await openDatabase(path, version: 3, onCreate: (Database d, int v) {
//         d.execute(
//             'create table course(id integer primary key autoincrement, name varchar(50), content varchar(255), hours integer )');
//       },onUpgrade: (Database dp, int oldv, int newv)async{
//         if(oldv<newv){
//           await dp.execute('alter table course add column level varchar(50)');
//
//           //,price double,rate double,available integer');
//         }
//       }
//       );
//       return _dp;
